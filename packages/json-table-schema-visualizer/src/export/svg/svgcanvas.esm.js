...
var Context = (function () {
  ...
  Context = function (o) {
    ...
    this.__rect = this.__createElement(
      "rect",
      {
        x: 0,
        y: 0,
    ...
    this.__root.appendChild(this.__rect);
  ...
  Context.prototype.__applyText = function (text, x, y, action) {
    ...
    /*if (title) {
            let titleElement = this.__createElement("title");
            titleElement.appendChild(this.__document.createTextNode('Тестовый комментрай'));
